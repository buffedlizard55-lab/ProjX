...
- `data/catalog.json` — entries and irregularities. Now contains **674 verified women (W-2026-001..674 — the prior 301 plus Session 13's structured-data volleyball passes of +257 (65 NCAA/US college indoor, 49 international beach, 143 international indoor league players across ~30 countries) and +116 in pass 2 (every league and country in the 1996-1999 birth-year band whose item links an Instagram, X or TikTok handle))** plus **57 REVIEW_REQUIRED candidates (R-2026-001..064 — each with evidence found + missing field + reason + date checked; never guessed; 51 of them `AGE_SOURCE_NOT_RECORDED` — a birth date exists in the structured record but carries no reference — plus one `AGE_CONFLICTING_VALUES`, Q58885490 Rhamat Alhassan, whose item records two different dates of birth so neither was promoted)** plus 18 irregularities (6 blocked requiring owner review; IRR-2026-09-06-007..015 follower-coverage gaps and session-10/12 variance flags; IRR-2026-09-06-016 evidence-tier register + spot-check audit for the Session-13 batch; IRR-2026-09-06-017 self-caught transcription risk, resolved; IRR-2026-09-06-018 pass-2 evidence tiers, the conflicting-DOB candidate and the remaining unsearched bands); discovery is activity-first (public fitness, swimwear/beachwear, fashion, athletics, lifestyle, esports etc.) then adult/woman/public-ownership verification; swimwear/bikini content is objectively classified (Swimwear/Bikini Fashion/Beachwear etc., never hot/sexy) and college attendance never proves adult; further rows require strongest available legitimate public evidence for each claim (Tier 1 where possible, multiple Tier 3 independent sources combined where needed — Tier 3 alone not sole sensitive proof when stronger reasonably available), line-by-line verification, and duplicate search (micro/college/swimwear creators without independent DOB/gender evidence remain `AGE_UNVERIFIED`/`GENDER_UNVERIFIED`/`REVIEW_REQUIRED` with full provenance, not VERIFIED nor discarded); 18+ via any reliable public evidence (published DOB, explicit age statement like “30-year-old” in reputable publication, first-party bio with age, sports bio, interview — never inferred from appearance/clothing/college).
