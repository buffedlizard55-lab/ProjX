...
- `data/catalog.json` — master entries and irregularities. Now contains **1493 verified women**,
  tagged `catalogType` = social (1301, has Instagram/TikTok) or reference (192, no Instagram/TikTok);
