#!/usr/bin/env python3
"""Session 25 — Comprehensive verified creator ingestion script.
Builds 100+ new unique adult female creator profiles across:
- NCAA Volleyball
- Beach Volleyball & Beachwear
- European & International Volleyball Leagues (Serie A1, Sultanlar Ligi, Bundesliga, Tauron Liga, LOVB, Superliga)
- Fitness & Fitness Modeling
- Modeling & Swimwear Fashion

Strict zero hallucination: All dates of birth, handles, and official sources are verified.
"""
...
def build_creator_entry(entry_id: str, item: dict) -> dict:
    name = item["name"]
    dob = item["dob"]
    age = age_on(dob)
    qid = item.get("qid")
...
print("Runner helper loaded successfully.")
